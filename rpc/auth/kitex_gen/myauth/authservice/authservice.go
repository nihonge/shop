...
func newServiceInfo(hasStreaming bool, keepStreamingMethods bool, keepNonStreamingMethods bool) *kitex.ServiceInfo {
	...
	handlerType := (*myauth.AuthService)(nil)
...
func deliverTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(myauth.DeliverTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(myauth.AuthService).DeliverTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *DeliverTokenByRPCArgs:
		success, err := handler.(myauth.AuthService).DeliverTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *DeliverTokenByRPCArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(myauth.DeliverTokenReq)
	}
...
func (p *DeliverTokenByRPCArgs) Unmarshal(in []byte) error {
	msg := new(myauth.DeliverTokenReq)
...
var DeliverTokenByRPCArgs_Req_DEFAULT *myauth.DeliverTokenReq

func (p *DeliverTokenByRPCArgs) GetReq() *myauth.DeliverTokenReq {
	if !p.IsSetReq() {
...
type DeliverTokenByRPCResult struct {
	Success *myauth.DeliveryResp
}

var DeliverTokenByRPCResult_Success_DEFAULT *myauth.DeliveryResp

func (p *DeliverTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(myauth.DeliveryResp)
	}
...
func (p *DeliverTokenByRPCResult) GetSuccess() *myauth.DeliveryResp {
	if !p.IsSetSuccess() {
...
func (p *DeliverTokenByRPCResult) SetSuccess(x interface{}) {
	p.Success = x.(*myauth.DeliveryResp)
}
...
func verifyTokenByRPCHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(myauth.VerifyTokenReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(myauth.AuthService).VerifyTokenByRPC(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *VerifyTokenByRPCArgs:
		success, err := handler.(myauth.AuthService).VerifyTokenByRPC(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *VerifyTokenByRPCArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(myauth.VerifyTokenReq)
	}
	return p.Req.FastRead(buf, _type, number)
}
...
var VerifyTokenByRPCArgs_Req_DEFAULT *myauth.VerifyTokenReq

func (p *VerifyTokenByRPCArgs) GetReq() *myauth.VerifyTokenReq {
	if !p.IsSetReq() {
...
type VerifyTokenByRPCResult struct {
	Success *myauth.VerifyResp
}

var VerifyTokenByRPCResult_Success_DEFAULT *myauth.VerifyResp

func (p *VerifyTokenByRPCResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(myauth.VerifyResp)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *VerifyTokenByRPCResult) GetSuccess() *myauth.VerifyResp {
	if !p.IsSetSuccess() {
...
func (p *kClient) DeliverTokenByRPC(ctx context.Context, Req *myauth.DeliverTokenReq) (r *myauth.DeliveryResp, err error) {
...
func (p *kClient) VerifyTokenByRPC(ctx context.Context, Req *myauth.VerifyTokenReq) (r *myauth.VerifyResp, err error) {
